...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().sku(DEFAULT_SKU).name(DEFAULT_NAME).basePrice(DEFAULT_BASE_PRICE).attributes(DEFAULT_ATTRIBUTES);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().sku(UPDATED_SKU).name(UPDATED_NAME).basePrice(UPDATED_BASE_PRICE).attributes(UPDATED_ATTRIBUTES);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getBasePrice()).isEqualByComparingTo(DEFAULT_BASE_PRICE);
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.sku(UPDATED_SKU).name(UPDATED_NAME).basePrice(UPDATED_BASE_PRICE).attributes(UPDATED_ATTRIBUTES);
        ...
        assertThat(testProduct.getBasePrice()).isEqualByComparingTo(UPDATED_BASE_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sku(UPDATED_SKU).name(UPDATED_NAME).basePrice(UPDATED_BASE_PRICE).attributes(UPDATED_ATTRIBUTES);
