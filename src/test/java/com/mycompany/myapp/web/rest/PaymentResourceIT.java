...
class PaymentResourceIT {
    ...
    private static final PaymentType DEFAULT_TYPE = PaymentType.RECEIPT;
    private static final PaymentType UPDATED_TYPE = PaymentType.DISBURSEMENT;

    private static final BigDecimal DEFAULT_AMOUNT = new BigDecimal(1);
    private static final BigDecimal UPDATED_AMOUNT = new BigDecimal(2);

    private static final Long DEFAULT_REFERENCE_ORDER_ID = 1L;
    private static final Long UPDATED_REFERENCE_ORDER_ID = 2L;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment()
            ...
            .referenceOrderId(DEFAULT_REFERENCE_ORDER_ID)
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment()
            ...
            .referenceOrderId(UPDATED_REFERENCE_ORDER_ID)
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getReferenceOrderId()).isEqualTo(DEFAULT_REFERENCE_ORDER_ID);
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].referenceOrderId").value(hasItem(DEFAULT_REFERENCE_ORDER_ID.intValue())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.referenceOrderId").value(DEFAULT_REFERENCE_ORDER_ID.intValue()))
    ...
    void putExistingPayment() throws Exception {
        ...
        assertThat(testPayment.getReferenceOrderId()).isEqualTo(UPDATED_REFERENCE_ORDER_ID);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.type(UPDATED_TYPE).createdAt(UPDATED_CREATED_AT);
