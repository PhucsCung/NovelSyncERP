...
class NotificationResourceIT {
    ...
    private static final NotificationType UPDATED_TYPE = NotificationType.ORDER_APPROVAL;
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getReferenceId()).isEqualTo(DEFAULT_REFERENCE_ID);
    ...
    void putExistingNotification() throws Exception {
        ...
        assertThat(testNotification.getReferenceId()).isEqualTo(UPDATED_REFERENCE_ID);
