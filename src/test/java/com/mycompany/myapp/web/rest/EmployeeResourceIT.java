...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().fullName(DEFAULT_FULL_NAME).phone(DEFAULT_PHONE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().fullName(UPDATED_FULL_NAME).phone(UPDATED_PHONE);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.fullName(UPDATED_FULL_NAME).phone(UPDATED_PHONE);
