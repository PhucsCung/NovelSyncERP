...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().code(UPDATED_CODE).name(UPDATED_NAME);
        return department;
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.code(UPDATED_CODE).name(UPDATED_NAME);
