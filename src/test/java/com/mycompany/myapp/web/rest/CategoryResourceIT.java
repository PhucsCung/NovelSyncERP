...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().code(UPDATED_CODE).name(UPDATED_NAME);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.code(UPDATED_CODE).name(UPDATED_NAME);
