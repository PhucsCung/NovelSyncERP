...
import InventoryTransactionComponent from '@/entities/inventory-transaction/inventory-transaction.vue';
import InventoryTransactionClass from '@/entities/inventory-transaction/inventory-transaction.component';
...
describe('Component Tests', () => {
  describe('InventoryTransaction Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<InventoryTransactionClass>(InventoryTransactionComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllInventoryTransactions();
      await comp.$nextTick();
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(inventoryTransactionServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(inventoryTransactionServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
