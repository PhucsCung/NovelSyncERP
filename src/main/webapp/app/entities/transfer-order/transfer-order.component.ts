...
export default class TransferOrder extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllTransferOrders();
  }
  ...
  public retrieveAllTransferOrders(): void {
  ...
  public prepareRemove(instance: ITransferOrder): void {
  ...
  public removeTransferOrder(): void {
    this.transferOrderService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('novelSyncErpApp.transferOrder.deleted', { param: this.removeId });
