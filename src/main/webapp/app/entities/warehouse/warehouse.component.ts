...
export default class Warehouse extends Vue {
  ...
  public retrieveAllWarehouses(): void {
  ...
  public prepareRemove(instance: IWarehouse): void {
  ...
  public removeWarehouse(): void {
    this.warehouseService()
      ...
      .then(() => {
        const message = this.$t('novelSyncErpApp.warehouse.deleted', { param: this.removeId });
