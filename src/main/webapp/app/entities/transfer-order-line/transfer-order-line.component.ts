...
export default class TransferOrderLine extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllTransferOrderLines();
  }
  ...
  public retrieveAllTransferOrderLines(): void {
  ...
  public prepareRemove(instance: ITransferOrderLine): void {
  ...
  public removeTransferOrderLine(): void {
    this.transferOrderLineService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('novelSyncErpApp.transferOrderLine.deleted', { param: this.removeId });
